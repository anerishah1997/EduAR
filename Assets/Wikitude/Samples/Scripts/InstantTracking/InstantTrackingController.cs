...
public class InstantTrackingController : SampleController
{
    ...
    protected override void Start() {
        ...
        modelIndex = StateNameController.modelId; // retrieving the value of the button clicked in the menuscene.
    ...
    public void OnSceneRecognized(InstantTarget target) {
        Debug.Log("OnSceneRecognized called");
        SetSceneActive(true);
    }

    public void OnSceneLost(InstantTarget target) {
        Debug.Log("OnSceneLost called");
